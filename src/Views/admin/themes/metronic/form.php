...
<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
	...
	<input type="hidden" name="module" value="<?= base64_encode('Adnduweb\Ci4_customer'); ?>" />
							...
							<div class="kt-form__body">
								<div class="kt-section kt-section--first">
									<div class="kt-section__body">
										<?= $this->include('\Adnduweb\Ci4_customer\Views\admin\themes\metronic\__form_section\general') ?>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="tab-pane" id="kt_user_edit_tab_2" role="tabpanel">
						<div class="kt-form kt-form--label-right">
							<div class="kt-form__body">
								<div class="kt-section kt-section--first">
									<div class="kt-section__body">
										<?= $this->include('\Adnduweb\Ci4_customer\Views\admin\themes\metronic\__form_section\information') ?>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="tab-pane" id="kt_user_edit_tab_3" role="tabpanel">
						<div class="kt-form kt-form--label-right">
							<div class="kt-form__body">
								<div class="kt-section kt-section--first">
									<div class="kt-section__body">
										<?= $this->include('\Adnduweb\Ci4_customer\Views\admin\themes\metronic\__form_section\carrier') ?>
									</div>
								</div>
							</div>
						</div>
