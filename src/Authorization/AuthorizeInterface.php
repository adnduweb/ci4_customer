...
namespace  Adnduweb\Ci4_customer\Authorization;
...
interface AuthorizeInterface
{
     ...
     * @return bool
     */
    public function addUCustomerToGroup(int $userid, $group);
     ...
     * @return mixed
     */
    public function removeCustomerFromGroup(int $userId, $group);
