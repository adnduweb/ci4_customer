...
class AuthException extends \DomainException implements ExceptionInterface
{
    ...
    {
        return new self(lang('Authcustomer.invalidModel', [$model]), 500);
    }
    ...
    {
        return new self(lang('Authcustomer.tooManyCredentials'), 500);
    }
    ...
    {
        return new self(lang('Authcustomer.invalidFields', [$key]), 500);
    }
    ...
    {
        return new self(lang('Authcustomer.unsetPasswordLength'), 500);
    }
    ...
    {
        return new self(lang('Authcustomer.noUserEntity'), 500);
    }
}
