...
class PwnedValidator extends BaseValidator implements ValidatorInterface
{
     ...
     * @return boolean
     */
    public function check(string $password, Entity $customer = null): bool
    {
        ...
        $this->error = lang('Authcustomer.errorPasswordPwned', [$password, $hits, $wording]);
        $this->suggestion = lang('Authcustomer.suggestPasswordPwned', [$password]);
