...
namespace Adnduweb\Ci4_customer\Entities;

use Michalsn\Uuid\UuidEntity;
use Adnduweb\Ci4_customer\Authorization\GroupModel;
use Adnduweb\Ci4_customer\Authorization\PermissionModel;
...
class Customer extends UuidEntity
{
    ...
    public function getPermissions()
    {
        ...
        if (empty($this->permissions)) {
            $this->permissions = (new PermissionModel())->getPermissionsForCustomer($this->id);
        }
    ...
    public function getRoles()
    {
        ...
        if (empty($this->roles)) {
            $groups = (new GroupModel())->getGroupsForCustomer($this->id);
